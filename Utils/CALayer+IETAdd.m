...
- (UIViewContentMode)contentMode {
    return IETCAGravityToUIViewContentMode(self.contentsGravity);
}

- (void)setContentMode:(UIViewContentMode)contentMode {
    self.contentsGravity = IETUIViewContentModeToCAGravity(contentMode);
}
...
- (void)addFadeAnimationWithDuration:(NSTimeInterval)duration curve:(UIViewAnimationCurve)curve {
    ...
    [self addAnimation:transition forKey:@"ietkit.fade"];
}

- (void)removePreviousFadeAnimation {
    [self removeAnimationForKey:@"ietkit.fade"];
}



UIViewContentMode IETCAGravityToUIViewContentMode(NSString *gravity) {
...
NSString *IETUIViewContentModeToCAGravity(UIViewContentMode contentMode) {
    switch (contentMode) {
